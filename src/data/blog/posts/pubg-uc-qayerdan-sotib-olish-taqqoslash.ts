...
const article: Article = {
  ...
  locales: {
    ...
    { t: "facts", items: [{"k":"Rasmiy kanal","v":"Midasbuy — Tencent'ning to'ldirish markazi"},{"k":"Mahalliy karta","v":"Midasbuy va xalqaro saytlarda UzCard, HUMO odatda yo'q"},{"k":"Xalqaro saytlar valyutasi","v":"Dollar, ustiga bank konvertatsiyasi qo'shiladi"},{"k":"So'mda to'lov","v":"UzCard, HUMO, Click yoki Uzum Bank — GemPay botida"},{"k":"To'lovdan oldin","v":"Player ID bo'yicha niknem bepul ko'rsatiladi"},{"k":"Qo'llab-quvvatlash","v":"O'zbek tilida, @StarsPaymeeSupport"}] },
    ...
    { t: "p", text: "GemPay boshqa yo'ldan boradi: butun jarayon Telegram ichida, so'mda va mahalliy to'lov tizimlari bilan kechadi. UzCard, HUMO, Click, Uzum Bank qabul qilinadi, ya'ni xorijiy karta ham, chet el hamyoni ham, VPN ham kerak emas. Qo'llab-quvvatlash o'zbek tilida ishlaydi va @StarsPaymeeSupport orqali bog'lanish mumkin." },
