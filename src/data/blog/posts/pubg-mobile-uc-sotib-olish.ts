...
const article: Article = {
  ...
  locales: {
    uz: {
      ...
      metaDescription: "PUBG Mobile UC ni O'zbekistonda so'mda sotib oling: Player ID kiriting, niknem bepul tekshiriladi, UzCard, HUMO, Click yoki Uzum Bank bilan to'lang. UC 2 daqiqada.",
    ...
    { t: "facts", items: [{"k":"Kerak bo'ladigan yagona ma'lumot","v":"Player ID raqami"},{"k":"To'lov valyutasi","v":"O'zbekiston so'mi, joriy summa botda ko'rsatiladi"},{"k":"To'lov usullari","v":"UzCard, HUMO, Click yoki Uzum Bank"},{"k":"Yetkazish vaqti","v":"Odatda taxminan 2 daqiqada"},{"k":"Kerak emas","v":"VPN, xorijiy karta, kriptovalyuta, akkaunt paroli"}] },
    ...
    { t: "table", caption: "PUBG Mobile UC to'lovida GemPay qabul qiladigan va umuman talab qilmaydigan usullar.", head: ["To'lov usuli","GemPay'da","Tasdiqlash","Izoh"], rows: [["UzCard","+","Bir necha soniya","O'zbekiston bank kartasi, to'lov so'mda"],["HUMO","+","Bir necha soniya","UzCard bilan bir xil tartib"],["Click","+","Bir necha soniya","Ilova yoki to'lov havolasi orqali"],["Uzum Bank","+","Bir necha soniya","Ilova yoki to'lov havolasi orqali"],["Payme yoki Paynet","-","Talab qilinmaydi","GemPay'da bu usullar ishlamaydi"],["Visa yoki Mastercard","-","Talab qilinmaydi","Xorijiy karta ochish shart emas"],["PayPal","-","Talab qilinmaydi","Xalqaro saytlarda so'raladi, GemPay'da yo'q"],["Kriptovalyuta, USDT","-","Talab qilinmaydi","Kripto sotib olishning hojati yo'q"],["VPN yoki region almashtirish","-","Talab qilinmaydi","To'lov O'zbekistondan to'g'ridan-to'g'ri o'tadi"]] },
    ...
    { t: "list", ordered: false, items: ["Player ID o'yindan nusxalab olindi, xotiradan qo'lda yozilmadi.","Bot ko'rsatgan niknem o'yindagi niknemim bilan bir xil.","Paket to'g'ri tanlandi va botdagi joriy summa ko'rildi.","Kartada yoki Click yoki Uzum Bank hisobida yetarli mablag' bor.","Telegramda ochilgan bot aynan @Gempayuz_bot, o'xshash nomli nusxa emas.","To'lov cheki va buyurtma raqami saqlab qo'yildi.","Hech kim mendan parol, SMS kod yoki akkauntga kirishni so'ramadi."] },
      ...
      faq: [
              {
                      ...
                      "a": "Ha. GemPay to'lovni O'zbekiston kartalari — UzCard va HUMO — hamda Click va Uzum Bank orqali so'mda qabul qiladi. Visa yoki Mastercard, xorijiy hamyon yoki kriptovalyuta talab qilinmaydi. VPN va region almashtirish ham kerak emas."
              },
              {
