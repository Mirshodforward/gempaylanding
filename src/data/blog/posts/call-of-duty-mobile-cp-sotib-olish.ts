...
const article: Article = {
  ...
  locales: {
    uz: {
      ...
      metaDescription: "Call of Duty: Mobile CP ni O'zbekistonda so'mda sotib oling: Player ID, bepul nickname tekshiruvi, UzCard/HUMO/Click/Uzum. CP 3 daqiqada tushadi.",
      excerpt: "CODM uchun CP ni Garena Player ID orqali so'mda to'ldirish: bepul nickname tekshiruvi, UzCard, HUMO, Click, Uzum Bank va uch daqiqalik yetkazish.",
      answer: "Call of Duty: Mobile uchun CP ni O'zbekistonda GemPay Telegram mini ilovasi orqali sotib olish mumkin: @Gempayuz_bot ni oching, Call of Duty: Mobile ni tanlang, Garena Player ID ni kiriting, nickname bepul tekshiriladi, paketni tanlab UzCard, HUMO, Click yoki Uzum Bank bilan so'mda to'lang. CP hisobingizga taxminan 3 daqiqada tushadi.",
      body: [
    ...
    { t: "facts", items: [{"k":"Qabul qilinadi","v":"UzCard, HUMO, Click yoki Uzum Bank"},{"k":"Valyuta","v":"Faqat so'm"},{"k":"Kerak emas","v":"Visa yoki Mastercard, kriptovalyuta, xorijiy hamyon"},{"k":"VPN","v":"Talab qilinmaydi"},{"k":"Konvertatsiya","v":"Yo'q, almashuv sizning kartangiz darajasida bo'lmaydi"},{"k":"Chek","v":"Botdagi buyurtmalar tarixida saqlanadi"}] },
      ...
      faq: [
              {
                      ...
                      "a": "Ha. GemPay Telegram mini ilovasi O'zbekiston kartalarini qabul qiladi: UzCard, HUMO, Click, Uzum Bank. Visa yoki Mastercard, kriptovalyuta va VPN kerak emas, to'lov to'g'ridan-to'g'ri so'mda o'tadi. Buyurtma Garena SG/MY Player ID bo'yicha bajariladi."
              },
              {
