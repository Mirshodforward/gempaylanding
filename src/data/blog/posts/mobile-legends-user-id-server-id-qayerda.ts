...
const article: Article = {
  ...
  locales: {
    ...
    { t: "list", ordered: false, items: ["User ID to'liq ko'chirilganmi — oxirgi raqam tushib qolmaganmi.","Server ID qavssiz, alohida maydonga kiritilganmi.","Ekranda chiqqan nickname sizniki yoki sovg'a qilayotgan odamniki mi.","Paket to'g'ri tanlanganmi — olmos paketlari odatda 86, 172, 257, 344, 706 kabi qadamlarda beriladi, lekin ro'yxat nashriyot tomonidan o'zgartirilib turadi, joriy variantlar botda ko'rinadi.","To'lov usuli tayyormi — UzCard, HUMO, Click yoki Uzum Bank, kartada mablag' yetarlimi."] },
    ...
    { t: "p", text: "Raqamlar qo'lingizda bo'lsa, tekshirish uchun to'lash shart emas. <a href=\"https://t.me/Gempayuz_bot\">@Gempayuz_bot</a> ni oching, Mobile Legends'ni tanlang, User ID va Server ID ni kiriting — nickname ekranda chiqadi. Shundan keyingina paketni tanlaysiz va so'mda UzCard, HUMO, Click yoki Uzum Bank orqali to'laysiz, olmos avtomatik tushadi. Joriy narxlar botning o'zida ko'rsatiladi, chunki ular kurs bilan birga o'zgaradi. O'yin bo'yicha umumiy ma'lumot <a href=\"/oyinlar/mobile-legends\">Mobile Legends sahifasida</a>, qolgan o'yinlar esa <a href=\"/oyinlar\">o'yinlar katalogida</a>." },
