...
const article: Article = {
  ...
  locales: {
    ...
    { t: "p", text: "Qolgan sabablar oddiyroq: 3-D Secure SMS kodi kiritilmagan yoki kod kech kelib sahifa yopilib qolgan; kartada internet to'lovlari yoqilmagan; kunlik yoki bir martalik limitga urilgansiz; balans yetarli emas. UzCard, HUMO, Click, Uzum Bank orqali to'lovda bu shartlar har xil ishlaydi, shuning uchun bir usul o'tmasa boshqasini sinab ko'rish mantiqan to'g'ri — lekin faqat birinchi to'lov aniq o'tmaganiga ishonch hosil qilganingizdan keyin." },
    ...
    { t: "list", ordered: false, items: ["User ID — profil oynasidagi asosiy raqam, qavssiz.","Server ID — o'sha qavs ichidagi raqam (ba'zi manbalarda Zone ID).","O'yin ichidagi nickname — buyurtmani ID bilan solishtirish uchun.","To'lov usuli: UzCard, HUMO, Click yoki Uzum Bank.","To'lov sanasi va vaqti — daqiqasigacha, telefondagi soat bo'yicha.","Chek yoki bank tranzaksiyasining to'liq skrinshoti."] },
