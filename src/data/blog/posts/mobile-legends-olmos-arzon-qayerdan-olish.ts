...
const article: Article = {
  ...
  locales: {
    uz: {
      ...
      answer: "Mobile Legends olmosini O'zbekistonda so'mda olishning ishlaydigan yo'li - ID orqali to'ldirish: GemPay boti Click, Uzum Bank, UzCard va HUMO ni qabul qiladi hamda faqat User ID bilan Server ID ni so'raydi. O'yin ichidagi do'kon xorijiy valyutadagi kartani, xorijiy saytlar esa Visa yoki Mastercard ni talab qiladi. Joriy narx botda ko'rinadi.",
      body: [
      ...
      faq: [
              {
                      ...
                      "a": "So'mda to'lanadigan va faqat ID orqali ishlaydigan xizmat kam qadam talab qiladi. GemPay Telegram boti Click, Uzum Bank, UzCard va HUMO ni qabul qiladi, VPN yoki xorijiy karta so'ramaydi. Buyurtma odatda bir necha daqiqada bajariladi, joriy narx esa paket tanlashda ko'rinadi."
              },
              {
