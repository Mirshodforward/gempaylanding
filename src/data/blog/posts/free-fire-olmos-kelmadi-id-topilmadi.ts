...
const article: Article = {
  ...
  locales: {
    ...
    { t: "list", ordered: false, items: ["UID — to'lovda ko'rsatilgan Player ID","Botdagi buyurtma raqami","To'lov cheki yoki tranzaksiya ID si","To'lov vaqti va usuli: UzCard, HUMO, Click yoki Uzum Bank","O'yin ichidagi nik va joriy olmos balansi skrinshoti","Xato matni chiqqan bo'lsa, uning skrinshoti"] },
