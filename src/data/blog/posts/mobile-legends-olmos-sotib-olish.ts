...
const article: Article = {
  ...
  locales: {
    uz: {
      ...
      metaDescription: "Mobile Legends olmos sotib olish: User ID va Server ID kiriting, nickname bepul tekshiriladi, Click, Uzum Bank, UzCard yoki HUMO bilan so'mda to'lang.",
      excerpt: "Telegram bot orqali Mobile Legends olmosini so'mda to'ldirish: ID kiritasiz, nickname bepul tekshiriladi, keyin Click, Uzum Bank, UzCard yoki HUMO bilan to'laysiz.",
      answer: "Mobile Legends olmos sotib olish uchun @Gempayuz_bot ni oching, Mobile Legends ni tanlang va User ID hamda Server ID (qavs ichidagi raqam) ni kiriting. Nickname bepul chiqadi; u to'g'ri bo'lsa paketni tanlab Click, Uzum Bank, UzCard yoki HUMO orqali so'mda to'laysiz. Olmos odatda bir daqiqada tushadi.",
      body: [
    ...
    { t: "facts", items: [{"k":"User ID","v":"Profilda ko'rinadigan ochiq raqam, masalan 123456789"},{"k":"Server ID","v":"O'sha raqamdan keyin qavs ichida turadi, masalan (1234)"},{"k":"Telegram","v":"@Gempayuz_bot ochiladigan istalgan qurilma, alohida ilova shart emas"},{"k":"To'lov","v":"UzCard, HUMO, Click yoki Uzum Bank — hammasi so'mda"},{"k":"Vaqt","v":"ID tayyor bo'lsa, butun jarayon odatda bir necha daqiqada tugaydi"}] },
    ...
    { t: "h2", id: "tolov-usullari", text: "To'lov usullari: Click, Uzum Bank, UzCard, HUMO" },
    ...
    { t: "table", caption: "To'lov usullari va ular qanday ishlashi. Barcha summalar so'mda, konvertatsiyasiz.", head: ["To'lov usuli","Qanday ishlaydi","Kimga qulay","Xorijiy karta","Odatiy tasdiqlash"], rows: [["Click","To'lov oynasi Click ilovasiga o'tkazadi, siz summani tasdiqlaysiz","Telefonida Click o'rnatilgan foydalanuvchi","-","Bir necha soniyada"],["Uzum Bank","Uzum Bank ilovasida to'lov tasdiqlanadi","Uzum Bank ilovasi asosiy to'lov vositasi bo'lganlar","-","Bir necha soniyada"],["UzCard","Karta ma'lumotlari kiritiladi, keyin bankdan SMS kod keladi","Ilovasiz, to'g'ridan-to'g'ri karta bilan to'laydiganlar","-","SMS kelishiga bog'liq"],["HUMO","Karta ma'lumotlari kiritiladi, keyin bankdan SMS kod keladi","HUMO kartasi asosiy karta bo'lganlar","-","SMS kelishiga bog'liq"]] },
    ...
    { t: "p", text: "Qaysi biri qulayroq — sizning odatingizga bog'liq. Telefonida Click yoki Uzum Bank ilovasi turgan bo'lsa, ular eng kam bosishni talab qiladi: to'lov oynasi ilovaga o'tkazadi va tasdiqlash bir necha soniyada tugaydi. Ilova o'rnatmaganlar uchun UzCard yoki HUMO kartasini to'g'ridan-to'g'ri kiritish oddiyroq, faqat SMS kodni kutishga tayyor turing. Yetkazish tezligi to'lov usuliga bog'liq emas — olmos to'lov tasdiqlangandan keyin bir xil tartibda yuboriladi." },
    ...
    { t: "links", title: "Mobile Legends bo'yicha qolgan maqolalar", items: [{"label":"User ID va Server ID qayerda turadi","href":"/blog/mobile-legends-user-id-server-id-qayerda"},{"label":"Olmos kelmadi: sabablari va yechimi","href":"/blog/mobile-legends-olmos-kelmadi-nima-qilish"},{"label":"Olmosni arzon va xavfsiz qayerdan olish","href":"/blog/mobile-legends-olmos-arzon-qayerdan-olish"},{"label":"Olmos nima va qanday paketlar bor","href":"/blog/mobile-legends-olmos-nima-va-paketlar"},{"label":"Mobile Legends to'ldirish sahifasi","href":"/oyinlar/mobile-legends"}] }
      ...
      faq: [
              ...
              },
              {
                      ...
                      "a": "Yo'q. GemPay O'zbekiston to'lov tizimlari bilan ishlaydi: UzCard, HUMO, Click, Uzum Bank. Xorijiy karta ham, valyuta konvertatsiyasi ham, VPN ham talab qilinmaydi. Summa so'mda hisoblanadi va to'lovdan oldin ekranda turadi."
              },
              {
