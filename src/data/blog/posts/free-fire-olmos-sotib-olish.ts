...
const article: Article = {
  ...
  locales: {
    uz: {
      ...
      metaDescription: "Free Fire olmos sotib olish: Player ID kiritasiz, nik bepul tekshiriladi, UzCard, HUMO, Click yoki Uzum Bank bilan so'mda to'laysiz. Olmos 2 daqiqada keladi.",
      ...
      answer: "Free Fire olmosini O'zbekistonda so'mda to'ldirish uchun GemPay botida Free Fire'ni tanlab, Player ID (UID) ni kiritasiz. Bot to'lovdan oldin akkaunt nikini bepul ko'rsatadi. Nikni tasdiqlagach paketni tanlab, UzCard, HUMO, Click yoki Uzum Bank bilan to'laysiz. Olmos odatda 2 daqiqada tushadi. Parol, VPN yoki xorijiy karta kerak emas.",
      body: [
    ...
    { t: "facts", items: [{"k":"Kerak bo'lgan yagona ma'lumot","v":"Player ID (UID) — odatda 8-12 raqamli ochiq son"},{"k":"To'lov usullari","v":"UzCard, HUMO, Click yoki Uzum Bank"},{"k":"Valyuta","v":"So'm, konvertatsiyasiz"},{"k":"Yetkazish","v":"Odatda 2 daqiqada, avtomatik"},{"k":"Nik tekshiruvi","v":"To'lovdan oldin, bepul"},{"k":"Versiya","v":"Global; Free Fire va Free Fire MAX bitta balansni bo'lishadi"},{"k":"Kerak emas","v":"Parol, SMS kod, VPN, Visa yoki Mastercard, kripto"}] },
    ...
    { t: "links", title: "Free Fire bo'yicha boshqa maqolalar", items: [{"label":"Olmos kelmadi yoki ID topilmadi: sabablari va yechimi","href":"/blog/free-fire-olmos-kelmadi-id-topilmadi"},{"label":"Free Fire olmosini arzon va xavfsiz qayerdan olish","href":"/blog/free-fire-olmos-arzon-qayerdan-olish"},{"label":"Free Fire olmosi nima va qanday paketlar bor","href":"/blog/free-fire-olmos-nima-va-paketlari"},{"label":"Bepul olmos: qaysi usullar haqiqiy, qaysilari firibgarlik","href":"/blog/free-fire-bepul-olmos-haqiqatmi"},{"label":"Free Fire to'ldirish sahifasi","href":"/oyinlar/free-fire"},{"label":"Barcha o'yinlar katalogi","href":"/oyinlar"}] }
      ...
      faq: [
              ...
              },
              {
                      ...
                      "a": "Ha. GemPay aynan mahalliy kartalar uchun ishlaydi: UzCard, HUMO, Click, Uzum Bank. Xorijiy karta ham, VPN ham, kripto ham kerak emas, to'lov so'mda o'tgani uchun konvertatsiya qo'shilmaydi."
              },
              {
